...
export function Puzzles() {
  ...
  // Start from defaults so the server-rendered HTML matches the first client
  // render, then hydrate real progress from localStorage after mount.
  const [progress, setProgress] = useState<PuzzleProgress>(DEFAULT_PROGRESS)
